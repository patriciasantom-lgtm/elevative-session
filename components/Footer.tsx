export default function Footer() {
  ...
  return (
    <footer className="py-10 px-6 bg-white border-t border-[#EEEEEE]">
      <div className="max-w-2xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-5">
        <p className="text-sm text-[#888888]">© 2025 Elevative</p>
        <div className="flex items-center gap-5">
          {links.map((l) => (
            <a
              ...
              aria-label={l.label}
              className="text-[#888888] hover:text-[#8b22a8] transition-colors"
            >
              {l.icon}
            </a>
          ))}
